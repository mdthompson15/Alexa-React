...
export interface AlexaSliderRadialProps {
  ...
  useDefaultSliderExpandTransition?: boolean;
}
export const AlexaSliderRadial = (
  props: React.PropsWithChildren<AlexaSliderRadialProps>
) => {
  return (
    <>
      <APLImports imports={imports} />
      <BaseComponent
        definition={{ type: 'AlexaSliderRadial', ...omit(props, ['children']) }}>
        {props.children}
      </BaseComponent>
    </>
  );
